...
def main():
 ...
 $$ |$$  /  $$$$$$\  $$$$$$\    $$$$$$\   $$$$$$\  $$ |$$\ $$$$$$$\  
 $$$$$  /   \____$$\ \_$$  _|  $$  __$$\ $$  __$$\ $$ |$$ |$$  __$$\ 
 $$  $$<    $$$$$$$ |  \033[1;36mDevOps tools installer\033[1;m |$$ |$$ |$$ |  $$ |
 \033[1;36m$$ |\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |
 $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ |
...
\033[1;91m[W] Before updating your system , please remove all  repositories to avoid any kind of problem .\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
...
4) Install the package GitLab

					''')
					repo = raw_input("\033[1;32mWhat do you want to do ?> \033[1;m")
					if repo == "1":
						cmd1 = os.system("sudo apt-get update -m")
						cmd2 = os.system("sudo apt-get install -y curl openssh-server ca-certificates")
					elif repo == "2":
						cmd3 = os.system("apt-get update -m")
					elif repo == "3":
						cmd4 = os.system("curl https://packages.gitlab.com/install/repositories/gitlab/gitlab-ee/script.deb.sh | sudo bash")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
